<template>
  <svg class="w-16 h-16 sm:w-20 sm:h-20 animate-wiggle pt-3" fill="#ffffff" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 470.064 470.064" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 470.064 470.064">
