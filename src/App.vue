  ...
  <nav class="bg-[#411717]">
    <div class="mx-auto max-w-7xl flex items-center px-6 py-4">
      ...
      <div class="ml-8">
        ...
        <RouterLink class="text-center cursor-pointer rounded-md px-5 py-2 text-sm font-medium text-white min-w-25 inline-block ml-4" :to="{ name: 'order-form' }">Cart</RouterLink>
      </div>
    </div>
  </nav>
